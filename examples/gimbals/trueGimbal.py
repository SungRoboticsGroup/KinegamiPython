...
gg.appendGeneralizedGimbal(RevoluteJoint(numSides, r, 3*np.pi/2, SE3.Rx(np.pi/2)))
gg.appendGeneralizedGimbal(RevoluteJoint(numSides, r, 3*np.pi/2, SE3.Ry(np.pi/2)))
