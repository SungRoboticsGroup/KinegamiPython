...
unextendedRevoluteJointLength = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3(), screwR).neutralLength
...
spine1Joint = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3.Trans([0,jointLength, jointLength/2]) @ SE3.Rz(np.pi/2), screwR)
...
topRightJoint2 = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3.Rz(np.pi/2) @ SE3.Trans([jointLength,0,jointLength]), screwR)
...
topLeftJoint2 = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3.Rz(-np.pi/2) @ SE3.Trans([jointLength,0,jointLength]), screwR)
...
middleRightJoint2 = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3.Trans([jointLength,0,jointLength]), screwR)
...
middleLeftJoint2 = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3.Rz(np.pi) @ SE3.Trans([jointLength,0,jointLength]), screwR)
...
spine2Joint = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3.Trans([0,-jointLength, jointLength/2]) @ SE3.Rz(-np.pi/2), screwR)
...
bottomRightJoint2 = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3.Rz(-np.pi/2) @ SE3.Trans([jointLength,0,jointLength]), screwR)
...
bottomLeftJoint2 = PrintedTransverseRevoluteJoint(r, -angle, angle, SE3.Rz(np.pi/2) @ SE3.Trans([jointLength,0,jointLength]), screwR)
