...
tree = origamiToPrinted(tree, 0.05)

plotPrintedTree(tree, "algorithmHandPrinted_PreOptimization")

tree = tree.squaredOptimize()

plotPrintedTree(tree, "algorithmHandPrinted_PostOptimization")

#tree.show()

tree.save("optimizedHandPrinted")
