...
link = LinkCSC(r=1, StartDubinsPose=SE3.Rx(-np.pi/4), EndDubinsPose=SE3.Ry(2*np.pi/3)@SE3.Tx(3.0), 
...
module = link.connectableModule(wallThickness=0.1, holeDiameter=0.2, numHoles=4, startRadius=1, endRadius=0.75)
#module = link.manifold(startRadius=1, endRadius=0.75, numSides=20, wallThickness=0.1)
analyzeProperties(module)
plotManifold(module)
save(module, "link_module.obj")
