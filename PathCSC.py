...
class PathCSC:
    ...
    def add(self, widget, showCircles=True, showPoses=True, 
        ...
        if showCircles:
            ...
            widget.plot_widget.addItem(circleStart)
            ...
            widget.plot_widget.addItem(circleEnd)
        ...
        if showTunit:
            ...
            widget.plot_widget.addItem(tUnit)
