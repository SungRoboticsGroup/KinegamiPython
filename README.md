...
The results will be in dist/GUI. Keep the executable and the _internal directory together within the same folder, but you can move that folder elsewhere.
