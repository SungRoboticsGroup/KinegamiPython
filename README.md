...
`pyinstaller printedGUI.spec` or `pyinstaller origamiGUI.spec` for the respective versions.

The results will be in dist/printed or dist/origami respectively. Keep the executable and the _internal directory together within the same folder, but you can move that folder elsewhere.
